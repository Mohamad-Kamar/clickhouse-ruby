...
CREATE TABLE IF NOT EXISTS clickhouse_ruby_test.events (
...
CREATE TABLE IF NOT EXISTS clickhouse_ruby_test.users (
    id UInt64,
    name String,
    email String,
    created_at DateTime DEFAULT now()
...
-- Insert sample data
INSERT INTO clickhouse_ruby_test.events (date, event_type, user_id, properties, count) VALUES
...
INSERT INTO clickhouse_ruby_test.users (id, name, email) VALUES
