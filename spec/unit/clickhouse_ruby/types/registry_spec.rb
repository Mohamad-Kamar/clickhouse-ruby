...
RSpec.describe ClickhouseRuby::Types::Registry do
  ...
  describe "#register_defaults" do
    ...
    describe "decimal types" do
      %w[Decimal Decimal32 Decimal64 Decimal128 Decimal256].each do |type_name|
        it "registers #{type_name}" do
          # Use a simple type string for base lookups
          type = registry.lookup("#{type_name}(10, 2)")
          expect(type).to be_a(ClickhouseRuby::Types::Decimal)
        end
      end
    end
